...
def trace_lines(frame, event, arg):
    ...
    global step
    step_info = {}
    step_info['step_no'] = step
    step_info['line_no'] = lineno
    step_info['func_name'] = func_name
    step_info['code_line'] = code_line
    step_info['frame_locals'] = frame_locals
    step+=1
    print(json.dumps(step_info, indent=1))
    print("\n"+"-" * 50+"\n")
